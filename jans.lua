	...
	local library = {design = getgenv().design == "kali" and "kali" or "zerius", tabs = {}, draggable = true, flags = {}, title = "zerius", open = false, mousestate = inputService.MouseIconEnabled, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = "zerius_configs", fileext = ".zer"}
